...
class LandingPage2Fragment : Fragment() {
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_landing_page2, container, false)

        val buttonNext: AppCompatImageButton = view.findViewById(R.id.intro_btn_next)

        buttonNext.setOnClickListener {
            (activity as IntroLandingPageActivity).findViewById<ViewPager2>(R.id.viewPager).currentItem = 2
        }
